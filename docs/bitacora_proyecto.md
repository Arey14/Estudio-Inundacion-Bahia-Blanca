...
#### 1. Metodología de Evaluación Adoptada
...
*   **Métricas Relativas de Jaccard y Dice:** Evaluamos el solapamiento relativo de cada modelo respecto a este consenso. Un IoU/Dice muy alto indica alineación con el consenso; valores más bajos nos exigen analizar si el modelo se desvía por exceso (sobreestimación) o por sensibilidad (captura de inundaciones reales omitidas por el consenso).
